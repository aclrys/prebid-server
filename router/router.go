...
import (
	...
	"github.com/aclrys/prebid-server/endpoints/events"
	infoEndpoints "github.com/aclrys/prebid-server/endpoints/info"
	"github.com/aclrys/prebid-server/endpoints/openrtb2"
	...
	"github.com/aclrys/prebid-server/pbs"
	pbc "github.com/aclrys/prebid-server/prebid_cache_client"
	"github.com/aclrys/prebid-server/router/aspects"
	"github.com/aclrys/prebid-server/server/ssl"
	storedRequestsConf "github.com/aclrys/prebid-server/stored_requests/config"
	"github.com/aclrys/prebid-server/usersync"
	"github.com/aclrys/prebid-server/util/sliceutil"
	"github.com/aclrys/prebid-server/util/uuidutil"
