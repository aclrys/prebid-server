...
[Create an issue](https://github.com/aclrys/prebid-server/issues/new) describing the motivation for your changes.
...
against the `master` branch of [our GitHub repository](https://github.com/aclrys/prebid-server/compare).
...
**Note**: We also have some [known intermittent failures](https://github.com/aclrys/prebid-server/issues/103).
