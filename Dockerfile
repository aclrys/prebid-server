...
RUN go build -mod=vendor -ldflags "-X github.com/aclrys/prebid-server/version.Ver=`git describe --tags | sed 's/^v//'` -X github.com/aclrys/prebid-server/version.Rev=`git rev-parse HEAD`" .
